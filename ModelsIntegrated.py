...
from invekos_lulc import invekos_lulc
...
def model_combined(CentralFolderPath, GDBPath, lower, upper, numbers):
    arcpy.env.overwriteOutput = True
    ...
    for x in range(int(lower), int(upper)):
        ...
        if folder_name:
            if folder_ws:
                ...
                addCoordinateFiles(CentralFolderPath, x, dictionary__x_low, dictionary__x_high, dictionary__y_low,
                                   dictionary__y_high)
                # Function to stitch the mosaic into one single raster
                stitchTiles(x, CentralFolderPath)
            print("............................................")
            print("............................................")
            print("FOLDERS CREATED AND TILES STITCHED :)")
            print("............................................")
            flag_check = flag()
            if flag_check is True:
                print("SOME C VALUES ARE MISSING; PLEASE NOTE THAT THEY HAVE BEEN REPLACED BY 0.5 FOR COMPUTATION "
                      "PURPOSES")

            print("----------------INPUTS PREPROCESSED; STARTING INVEST NOW----------------------------------------")
